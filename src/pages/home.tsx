...
export function HomePage() {
  ...
  async function loadContextData() {
    ...
    try {
      ...
      if (monthMoods && monthAnchors) {
        setStreaks(calculateStreaks(monthMoods as MoodLog[], monthAnchors as DailyAnchor[]))
      }

      // ─── Companion : check-in + mood d'hier ───
...
//     } catch (err: any) {
//       console.error("Failed to save anchor:", err)
//       // Pas de toast ici car trop fréquent (autosave à chaque frappe)
//     }
//   }
