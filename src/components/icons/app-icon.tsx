...
const signatureIcons = {
  ...
  streak: StreakIcon,
  wrapped: WrappedIcon,
  "anchor-future": AnchorFutureIcon,
  "anchor-mindbody": AnchorMindbodyIcon,
  "anchor-life": AnchorLifeIcon,
  "nav-home": NavHomeIcon,
  "nav-checkin": NavCheckinIcon,
  "nav-patterns": NavPatternsIcon,
  "nav-move": NavMoveIcon,
  "nav-more": NavMoreIcon,
  "hub-letters": HubLettersIcon,
  "hub-circle": HubCircleIcon,
  "hub-jar": HubJarIcon,
  "hub-wrapped": HubWrappedIcon,
  "hub-compass": HubCompassIcon,
  "hub-settings": HubSettingsIcon,
  "empty-jar": EmptyJarIcon,
  "empty-letters": EmptyLettersIcon,
  "empty-circle": EmptyCircleIcon,
  "empty-wrapped": EmptyWrappedIcon,
} as const
